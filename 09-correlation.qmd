...
* I would also recommend retaining demographic variables such as age and gender in the final data frame. Keeping all wrangling in one place reduces the risk of human error from managing multiple data objects.
